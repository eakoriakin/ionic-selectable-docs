...
export default {
  head() {
    return {
      title: `Ionic Selectable privacy policy`,
      meta: [
        {
          hid: 'description',
          name: 'description',
          content: `Ionic Selectable privacy policy`,
        },
      ],
    };
  },
...
<template>
  <div class="app-privacy-policy mt-4">
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          &quot;Our&quot; in this Agreement) refers to Ionic Selectable.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Ionic Selectable, accessible from
          <a href="https://ionic-selectable.net" rel="external nofollow noopener" target="_blank"
            >https://ionic-selectable.net</a
          >
        </p>
      </li>
      <li>
    ...
    <p>
      ...
      <a href="https://www.termsfeed.com/blog/cookies/#What_Are_Cookies" target="_blank">TermsFeed website</a> article.
    </p>
    ...
    <ul>
      <li>By email: eakoryakin@gmail.com</li>
    </ul>
  </div>
</template>
